...
#SBATCH --array=0-204 ## number of jobs to run "in parallel" 
...
#SBATCH --job-name="ipd2c_bayesian_\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=ipd2c_bayesian.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
#SBATCH --error=ipd2c_bayesian.%A_%a.e
