...
#SBATCH --job-name="ipd2b_bayesian_\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=ipd2b_bayesian.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
#SBATCH --error=ipd2b_bayesian.%A_%a.e
