...
#SBATCH --array=0-299 ## number of jobs to run "in parallel" 
...
#SBATCH --job-name="ipd1a_frequentist_\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=ipd1a_frequentist.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
