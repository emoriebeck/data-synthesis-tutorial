...
#SBATCH --array=0-18 ## number of jobs to run "in parallel" 
...
#SBATCH --job-name="ipd2b_freq_pred_\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=ipd2b_freq_pred.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
