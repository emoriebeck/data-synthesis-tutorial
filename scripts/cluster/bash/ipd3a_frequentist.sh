...
#SBATCH --array=0-399 ## number of jobs to run "in parallel" 
...
#SBATCH --job-name="ipd3_frequentist_\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=ipd3_frequentist.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
